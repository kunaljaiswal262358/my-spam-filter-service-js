...
// This line creates the 'models' directory if it's missing.
// { recursive: true } prevents errors if the folder already exists.
fs.mkdirSync(MODELS_DIR, { recursive: true });

// --- 3. LOAD DATA & SPLIT ---
console.log('Loading data...');
const allData = loadAllData(); // This line is now correct
...
// --- 4. HYPERPARAMETER TUNING (MODEL A) ---
...
// Train and save Model A (From Scratch)
